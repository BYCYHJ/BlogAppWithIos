...
export default function LoginWithNamePwd({navigationRef}){
    ...
    const handleLogin = async () =>{
        ...
        //const response = await axios.post(
            //'https://localhost:7080/Login/Login',
            //userLogin,
        //     {
        //         headers:{
    ...
    return(
        <View>
            <Form style={{backgroundColor:'transparent',marginTop:'20%'}}>
                <Form.Item label={false} style={styles.FormItem}>
                    <Text style={{height:0}}></Text>
                    <View style={styles.UsernameAPassword}>
                        <Svg style={styles.UAPSvg} viewBox="0 0 1024 1024" p-id="7972" width={'10%'} height={'100%'}>
                ...
                <Form.Item label={false} style={styles.FormItem}>
                    <Text></Text>
                    <View style={styles.UsernameAPassword}>
                        <Svg style={styles.UAPSvg} viewBox="0 0 1024 1024" p-id="10010" id="mx_n_1703121978630" width={'10%'} height={'100%'}>
                ...
                <View style={styles.BottomArea}>
                    ...
                    onPressIn={()=>SetBackground('grey')} onPressOut={() => SetBackground('#edd038')} onPress={handleLogin}>
