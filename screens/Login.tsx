...
import { Dimensions, ScrollView, StyleSheet, Text, View, Alert, Button, TouchableOpacity, ImageBackground, Pressable, Image } from 'react-native';
...
export default function Login({ navigation }) {
    ...
    return (
        <LinearGradient colors={['#f4dba4', '#fbf3e0', 'white']} style={styles.home}>
            ...
            <View style={[styles.box, { zIndex: 1, position: 'absolute' }, { backgroundColor: 'transparent' }]}>
                ...
                <View style={[styles.flipCardStyle]}>
                    {/* ,{height:!loginMethod?windowSet.height*0.45:windowSet.height*0.35} */}
            ...
            <View style={styles.BottomPhoneArea}>
                <View style={{ height: 0.5, backgroundColor: 'black', width: '100%', zIndex: 1 }}></View>
                <View style={{}}>
                    {!loginMethod ?
                        <Button onPress={changeLoginMethod} color={'#818181'} title='Or Try Logging in with Your Phone'></Button> :
                        <Button onPress={changeLoginMethod} color={'#818181'} title='Or Try Logging in with Your Account'></Button>}
                </View>
            </View>
            {/* </ImageBackground> */}
        </LinearGradient>
...
const styles = StyleSheet.create({
    ...
    box: {
        ...
        zIndex: 1,
        paddingTop: windowSet.height * 0.2
    ...
    BottomPhoneArea: {
        ...
        height: 60,
        alignItems: 'center',
        marginTop: windowSet.height*0.8,
        position: 'absolute',
    }
});
type UserLogin = {
